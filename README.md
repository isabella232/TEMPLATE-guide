...
This template is used to create a guide that instruct customers on how to integrate your service with Auth0. This is typically used when an integration can't be installed directly via the Marketplace.
